...
async def forward_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Check if a photo exists and forward it to the owner
    if update.message.photo:
        try:
            ...
            await update.message.reply_text("Sorry, there was an error sending your photo.")
    else:
...
async def forward_video(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Check if a video exists and forward it to the owner
    if update.message.video:
        try:
            ...
            await update.message.reply_text("Sorry, there was an error sending your video.")
    else:
        await update.message.reply_text("No video found in your message.")
